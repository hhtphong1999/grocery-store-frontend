...
const Pagination = ({ categoriesPerPage, totalCategories, paginate, first, last, lengthPage }) => {
        ...
        <div className="row">
            <div className="col-md-5">
                <div className="dataTables_info">
                    Showing {first + 1} to {last - (categoriesPerPage - lengthPage)} of {totalCategories} entries
                </div>
            </div>
